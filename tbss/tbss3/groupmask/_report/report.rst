Node: tbss3 (groupmask (fsl)
============================


 Hierarchy : tbss.tbss3.groupmask
 Exec ID : groupmask
...
* out_file : /mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss3/groupmask/DTI__FA_prep_warp_merged_mask.nii.gz
...
* cmdline : fslmaths /mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss3/mergefa/DTI__FA_prep_warp_merged.nii.gz -max 0 -Tmin -bin /mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss3/groupmask/DTI__FA_prep_warp_merged_mask.nii.gz -odt char
* duration : 5.9448170000000005
* hostname : fmri-rotem
* prev_wd : /mnt/z/Rotem_Orad/scripts/PhD/tbss
* working_dir : /mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss3/groupmask
