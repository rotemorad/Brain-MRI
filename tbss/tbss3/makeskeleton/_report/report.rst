Node: tbss3 (makeskeleton (fsl)
===============================


 Hierarchy : tbss.tbss3.makeskeleton
 Exec ID : makeskeleton
...
* projected_data : <undefined>
* skeleton_file : /mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss3/makeskeleton/DTI__FA_prep_warp_merged_masked_mean_skeleton.nii.gz
...
* cmdline : tbss_skeleton -i /mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss3/meanfa/DTI__FA_prep_warp_merged_masked_mean.nii.gz -o /mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss3/makeskeleton/DTI__FA_prep_warp_merged_masked_mean_skeleton.nii.gz
* duration : 4.237162
* hostname : fmri-rotem
* prev_wd : /mnt/z/Rotem_Orad/scripts/PhD/tbss
* working_dir : /mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss3/makeskeleton
