Node: tbss4 (distancemap (fsl)
==============================


 Hierarchy : tbss.tbss4.distancemap
 Exec ID : distancemap
...
* in_file : /mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss4/invertmask/DTI__FA_prep_warp_merged_mask_inv.nii.gz
* invert_input : <undefined>
* local_max_file : <undefined>
* mask_file : <undefined>
...
* cmdline : distancemap --out=/mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss4/distancemap/DTI__FA_prep_warp_merged_mask_inv_dstmap.nii.gz --in=/mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss4/invertmask/DTI__FA_prep_warp_merged_mask_inv.nii.gz
* duration : 2.319896
* hostname : fmri-rotem
* prev_wd : /mnt/z/Rotem_Orad/scripts/PhD/tbss
* working_dir : /mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss4/distancemap
