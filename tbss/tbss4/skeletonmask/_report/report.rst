Node: tbss4 (skeletonmask (fsl)
===============================


 Hierarchy : tbss.tbss4.skeletonmask
 Exec ID : skeletonmask
...
* in_file : /mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss3/makeskeleton/DTI__FA_prep_warp_merged_masked_mean_skeleton.nii.gz
* in_file2 : <undefined>
* mask_file : <undefined>
* op_string : -thr 0.2 -bin
...
* out_file : /mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss4/skeletonmask/DTI__FA_prep_warp_merged_masked_mean_skeleton_mask.nii.gz
...
* cmdline : fslmaths /mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss3/makeskeleton/DTI__FA_prep_warp_merged_masked_mean_skeleton.nii.gz -thr 0.2 -bin /mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss4/skeletonmask/DTI__FA_prep_warp_merged_masked_mean_skeleton_mask.nii.gz
* duration : 0.469655
* hostname : fmri-rotem
* prev_wd : /mnt/z/Rotem_Orad/scripts/PhD/tbss
* working_dir : /mnt/z/Rotem_Orad/scripts/Brain-MRI/tbss/tbss4/skeletonmask
